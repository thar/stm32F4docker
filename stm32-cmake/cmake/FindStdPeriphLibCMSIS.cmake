...
IF(STM32_FAMILY STREQUAL "F1")
    IF(NOT StdPeriph_Lib_DIR)
        SET(StdPeriph_Lib_DIR "/opt/STM32Cube_FW_F1_V1.2.0")
        MESSAGE(STATUS "No StdPeriph_Lib_DIR specified, using default: " ${StdPeriph_Lib_DIR})
    ENDIF()
...
ELSEIF(STM32_FAMILY STREQUAL "F2")
    IF(NOT StdPeriph_Lib_DIR)
        SET(StdPeriph_Lib_DIR "/opt/STM32Cube_FW_F2_V1.1.1")
        MESSAGE(STATUS "No StdPeriph_Lib_DIR specified, using default: " ${StdPeriph_Lib_DIR})
    ENDIF()
...
ELSEIF(STM32_FAMILY STREQUAL "F3")
    IF(NOT StdPeriph_Lib_DIR)
        SET(StdPeriph_Lib_DIR "/opt/STM32Cube_FW_F3_V1.6.0")
        MESSAGE(STATUS "No StdPeriph_Lib_DIR specified, using default: " ${StdPeriph_Lib_DIR})
    ENDIF()
...
ELSEIF(STM32_FAMILY STREQUAL "F4")
    IF(NOT StdPeriph_Lib_DIR)
        SET(StdPeriph_Lib_DIR "/opt/STM32F4xx_DSP_StdPeriph_Lib_V1.8.0")
        MESSAGE(STATUS "No StdPeriph_Lib_DIR specified, using default: " ${StdPeriph_Lib_DIR})
    ENDIF()
...
ELSEIF(STM32_FAMILY STREQUAL "F7")
    IF(NOT StdPeriph_Lib_DIR)
        SET(StdPeriph_Lib_DIR "/opt/STM32Cube_FW_F7_V1.3.0")
        MESSAGE(STATUS "No StdPeriph_Lib_DIR specified, using default: " ${StdPeriph_Lib_DIR})
    ENDIF()
...
ELSEIF(STM32_FAMILY STREQUAL "F0")
    IF(NOT StdPeriph_Lib_DIR)
        SET(StdPeriph_Lib_DIR "/opt/STM32Cube_FW_F0_V1.4.0")
        MESSAGE(STATUS "No StdPeriph_Lib_DIR specified, using default: " ${StdPeriph_Lib_DIR})
    ENDIF()
...
ELSEIF(STM32_FAMILY STREQUAL "L0")
    IF(NOT StdPeriph_Lib_DIR)
        SET(StdPeriph_Lib_DIR "/opt/STM32Cube_FW_L0_V1.7.0")
        MESSAGE(STATUS "No StdPeriph_Lib_DIR specified, using default: " ${StdPeriph_Lib_DIR})
    ENDIF()
...
FIND_PATH(CMSIS_COMMON_INCLUDE_DIR ${CMSIS_COMMON_HEADERS}
    ...
    HINTS ${StdPeriph_Lib_DIR}/Libraries/CMSIS/Include/
    CMAKE_FIND_ROOT_PATH_BOTH
)

FIND_PATH(CMSIS_DEVICE_INCLUDE_DIR ${CMSIS_DEVICE_HEADERS}
    PATH_SUFFIXES include stm32${STM32_FAMILY_LOWER} cmsis
    HINTS ${StdPeriph_Lib_DIR}/Libraries/CMSIS/Device/ST/STM32${STM32_FAMILY}xx/Include
    CMAKE_FIND_ROOT_PATH_BOTH
)
...
FOREACH(SRC ${CMSIS_DEVICE_SOURCES})
    ...
    FIND_FILE(SRC_FILE ${SRC}
        ...
        HINTS ${StdPeriph_Lib_DIR}/Libraries/CMSIS/Device/ST/STM32${STM32_FAMILY}xx/Source/Templates/
        CMAKE_FIND_ROOT_PATH_BOTH
    )
...
IF(STM32_CHIP_TYPE)
    ...
    FIND_FILE(SRC_FILE ${CMSIS_STARTUP_SOURCE}
        PATH_SUFFIXES src stm32${STM32_FAMILY_LOWER} cmsis
        HINTS ${StdPeriph_Lib_DIR}/Libraries/CMSIS/Device/ST/STM32${STM32_FAMILY}xx/Source/Templates/gcc/
        CMAKE_FIND_ROOT_PATH_BOTH
    )
    LIST(APPEND CMSIS_SOURCES ${SRC_FILE})
ENDIF()
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(StdPeriphLibCMSIS DEFAULT_MSG CMSIS_INCLUDE_DIRS CMSIS_SOURCES)
