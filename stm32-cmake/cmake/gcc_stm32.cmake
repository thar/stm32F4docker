...
SET(CMAKE_RANLIB ${TOOLCHAIN_BIN_DIR}/${TARGET_TRIPLET}-gcc-ranlib${TOOL_EXECUTABLE_SUFFIX} CACHE INTERNAL "gcc-ranlib")
SET(CMAKE_NM ${TOOLCHAIN_BIN_DIR}/${TARGET_TRIPLET}-gcc-nm${TOOL_EXECUTABLE_SUFFIX} CACHE INTERNAL "gcc-nm")

SET(CMAKE_C_FLAGS_DEBUG "-Og -g -fstack-usage" CACHE INTERNAL "c compiler flags debug")
SET(CMAKE_CXX_FLAGS_DEBUG "-Og -g -fstack-usage" CACHE INTERNAL "cxx compiler flags debug")
SET(CMAKE_ASM_FLAGS_DEBUG "-g -fstack-usage" CACHE INTERNAL "asm compiler flags debug")
SET(CMAKE_EXE_LINKER_FLAGS_DEBUG "--specs=rdimon.specs --specs=nano.specs -fstack-usage" CACHE INTERNAL "linker flags debug")
...
SET(CMAKE_EXE_LINKER_FLAGS_RELEASE "-flto --specs=rdimon.specs --specs=nano.specs" CACHE INTERNAL "linker flags release")
...
FUNCTION(STM32_PRINT_SIZE_OF_TARGETS TARGET)
    ...
    ELSE()
      SET(FILENAME "${TARGET}")
    ENDIF()
    add_custom_command(TARGET ${TARGET} POST_BUILD COMMAND ${CMAKE_SIZE} --format=SysV ${FILENAME})
ENDFUNCTION()
